...
-- LEFT (OUTER) JOIN - PESSOAS QUE RESERVARAM HOTEL U PESSOAS QUE NAO RESERVARAM HOTEL
----------------------------------------------------------------------------------------------------
SELECT P.Nome, H.Nome FROM
PESSOA P LEFT JOIN HOTEL H
ON P.Cod_Hotel = H.Cod
...
-- RIGHT (OUTER) JOIN - HOTEIS QUE FORAM RESERVADOS POR PESSOAS U HOTEIS QUE NAO FORAM RESERVADOS POR PESSOAS
----------------------------------------------------------------------------------------------------
SELECT P.Nome, H.Nome FROM
PESSOA P RIGHT JOIN HOTEL H
ON P.Cod_Hotel = H.Cod
...
-- FULL (OUTER) JOIN - (PESSOAS QUE RESERVARAM HOTEL U PESSOAS QUE NAO RESERVARAM HOTEL) U
--                     (HOTEIS QUE FORAM RESERVADOS POR PESSOAS U HOTEIS QUE NAO FORAM RESERVADOS POR PESSOAS)
----------------------------------------------------------------------------------------------------
SELECT P.Nome, H.Nome FROM
...
-- OUTER EXCLUDING JOIN - PESSOAS QUE NAO RESERVARAM HOTEL U HOTEIS QUE NAO FORAM RESERVADOS POR PESSOAS
----------------------------------------------------------------------------------------------------
SELECT P.Nome, H.Nome FROM
PESSOA P FULL JOIN HOTEL H
ON P.Cod_Hotel = H.Cod
